...
from . import accounts, analytics, debts, feed, giveaways, home, market, prefs, salary, triage, undo

router = APIRouter()
for _module in (home, giveaways, feed, market, analytics, prefs, accounts, debts, salary, triage, undo):
